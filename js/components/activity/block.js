...
<article class="bg-white p-4">
   <img class='w-100 object-fit-cover mb-4' src=${data.content.image} />
...
const shortBlock = (data) => {
  return `
    <article class="bg-white flex-column flex-lg-row d-flex align-items-center justify-content-between p-4" >
